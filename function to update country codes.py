...
# #write data to local file to check
# data = gitdata.to_csv(r"C:\Users\kayleigh.swords\OneDrive - Mary Immaculate "\
#                       r"College\1 Personal\Cert in Introductory data Analytics "\
#                           r"(with Python)\Project Folder\local_Data_Checker.csv")
